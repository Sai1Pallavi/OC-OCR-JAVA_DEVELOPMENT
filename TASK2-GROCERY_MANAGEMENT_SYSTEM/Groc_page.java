	...
	public Groc_page() {
		...
		edit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Class.forName("com.mysql.cj.jdbc.Driver");
				sqlcon=DriverManager.getConnection(con,username,password);
				pst=sqlcon.prepareStatement("update logintable set Emp_ID=?,Emp_name=?,Address=?,Phone=?,Password=?");
				pst.setString(1,eid.getText());
				pst.setString(2,ename.getText());
				pst.setString(3,eaddress.getText());
				pst.setString(4,phone.getText());
		...
		delete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {	
					...
					String query="delete from logintable where Emp_ID="+value;
		...
		delete.setBounds(558, 243, 89, 32);
		...
		mainhead.setBounds(384, 11, 180, 30);
